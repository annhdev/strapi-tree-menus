type TimeChangeHandler = (params: { target: { name: string; value: string | undefined; type: string } }) => void
...
export const handleTimeChangeEvent = (onChange: TimeChangeHandler, name: string, type: string, time?: string): void => {
