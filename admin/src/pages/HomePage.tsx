...
import { Layouts, Page, BackButton, unstable_useDocumentLayout as useDocumentLayout, } from '@strapi/strapi/admin';
...
import { ListFieldLayout, useDoc } from '../hooks/useDocument';
...
const HomePage = () => {
  ...
  const { list }: any = useDocumentLayout(model);

  const [displayedHeaders, setDisplayedHeaders] = useState<ListFieldLayout[]>([]);
